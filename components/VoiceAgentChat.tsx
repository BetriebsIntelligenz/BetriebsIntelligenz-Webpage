...
import { Mic, X, Send, Play, Square, RotateCcw, Pause, Sparkles, AudioLines, Loader2, Bot } from 'lucide-react';
  ...
  const handleSend = async () => {
    ...
    try {
        ...
        const replyResponse = await ai.models.generateContent({
            model: 'gemini-2.5-flash',
            contents: `Du bist ein hilfreicher Assistent für eine Firmen-Wissensdatenbank. Antworte kurz, prägnant und hilfreich auf: "${userPrompt}"`
        });
        ...
        {isOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-lg h-[650px] max-h-[90vh] bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 rounded-[40px] shadow-2xl flex flex-col overflow-hidden border border-white/20 text-white"
            >
              ...
              {/* Header */}
              <div className="relative z-10 px-6 py-5 flex items-center justify-between border-b border-white/10 bg-white/5 backdrop-blur-md">
